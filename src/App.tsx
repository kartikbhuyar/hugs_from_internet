...
import { Heart, Save, Camera } from 'lucide-react';
...
function App() {
  ...
  const [activeSection, setActiveSection] = useState<'letters' | 'memories'>('letters');
  ...
  useEffect(() => {
    ...
    if (savedMemories) {
      ...
      const memoriesWithDates = memoriesData.map((memory: any) => ({
        ...memory,
        uploadedAt: new Date(memory.uploadedAt)
      }));
      setMemories(memoriesWithDates);
      console.log('Loaded memories:', memoriesWithDates);
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 via-blue-900 to-indigo-900 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-6xl mx-auto text-center py-12 px-4">
          ...
          <div className="mb-6">
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 bg-clip-text text-transparent mb-4 animate-fade-in">
              {activeSection === 'letters' ? 'Open When...' : 'Memories'}
            </h1>
            ...
            <div className="max-w-4xl mx-auto px-4 pb-12">
              <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
                  ...
                  <div>
                    <div className="text-3xl font-bold text-green-400 mb-2">{memories.length}</div>
                    <div className="text-gray-300 font-medium">Memories Saved</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Footer - only show on letters section */}
        {activeSection === 'letters' && (
          <div className="max-w-4xl mx-auto px-4 pb-12">
